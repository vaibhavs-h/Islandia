...
class MainFlutterWindow: NSWindow {
  ...
  private let bluetoothBatteryChannel = BluetoothBatteryChannel()
  private let bluetoothClassicChannel = BluetoothClassicChannel()
  ...
  override func awakeFromNib() {
    ...
    bluetoothBatteryChannel.register(on: flutterViewController)
    bluetoothClassicChannel.register(on: flutterViewController)
